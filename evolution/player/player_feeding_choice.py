...
class PlayerAttackWithCarnivore(PlayerFeedingChoice):
    ...
    def __repr__(self):
        return "PlayerAttackWithCarnivore({},{},{})".format(self.get_carnivore_index(),
                                                            self.get_target_player_index(),
                                                            self.get_target_species_index())

    def __eq__(self, other):
        if not isinstance(other, PlayerAttackWithCarnivore):
            return False
        return self.get_carnivore_index() == other.get_carnivore_index() and \
               self.get_target_player_index() == other.get_target_player_index() and \
               self.get_target_species_index() == other.get_target_species_index()
